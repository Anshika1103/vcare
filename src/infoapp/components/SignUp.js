                    ...
                    <div className="card">
                        <div className="card-body text-center d-flex flex-column align-items-center">
                            ...
                            <form method="post">
                                ...
                                <div className="mb-3"><input className="form-control" type="text" name="hospital" placeholder="Hospital"/></div>
                                <div className="mb-3"><input className="form-control" type="text" name="name" placeholder="Enter your name"/></div>
