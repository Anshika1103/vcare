              ...
              <div className="col d-md-flex align-items-md-end align-items-lg-center mb-5">
                <div>
                  ...
                  <p className="text-muted mb-4">
                    Users can access a calendar feature to view their upcoming
                    appointments, schedule new appointments, and receive
            ...
            >
              ...
              <div className="col d-md-flex align-items-md-end align-items-lg-center mb-5">
                <div>
                  ...
                  <p className="text-muted mb-4">
                    DocSphere provides personalized medical treatment plans and
                    medication recommendations through its prescription feature
                  </p>
                  <button className="btn btn-primary shadow" type="button">
                    Learn more
                  </button>
            ...
            >
              ...
              <div className="col d-md-flex align-items-md-end align-items-lg-center mb-5">
                <div>
                  ...
                  <p className="text-muted mb-4">
                    Users on DocSphere can share their research, clinical
